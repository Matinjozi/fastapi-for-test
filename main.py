...
def jwt_verify(token: str):
    ...
    try:
        ...
        cursor.execute('''SELECT hashed_password FORM form_login where hashed_password = %s;''', [decode_token])
...
if __name__ == '__main__':
    ...
    uvicorn.run('main:app', host='localhost', port=20010, reload=True, workers=1)
